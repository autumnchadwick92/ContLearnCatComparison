...
def get_permuted_CORE50(path, batch_size):
    ...
    train_set = CIFAR10(root=path, train=True, download=True, transform=transfrom)
    test_set = CIFAR10(root=path, train=False, download=True, transform=transfrom)
